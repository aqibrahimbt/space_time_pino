...
def main(log: str = "WARNING", log_file: Optional[str] = None, H=0.01):
    ...
    try:
        for num_workers in num_workers_list:
            ...
            try:
                client = Client(n_workers=num_workers, threads_per_worker=1, timeout="300s", memory_limit="16GB", silence_logs=logging.INFO, asynchronous=False)
